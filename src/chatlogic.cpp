...
ChatLogic::ChatLogic()
{
    ...
    // ChatLogic no longer owns the ChatBot instance
...
ChatLogic::~ChatLogic()
{
    ...
    // ChatLogic no longer owns the instance so delete is no longer necessary
    // delete chatbot instance
    // delete _chatBot;

    // delete may not be necessary now
    // delete all nodes
    ...
    // each edge is at least uniquely owned by a node
    // delete may no longer be necessary
    // delete all edges
